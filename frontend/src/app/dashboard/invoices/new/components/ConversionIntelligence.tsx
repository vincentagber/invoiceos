        ...
        <div className="bg-slate-900 rounded-3xl p-6 text-white space-y-6 shadow-2xl border border-white/10 relative overflow-hidden group">
            ...
            <div className="flex items-center justify-between relative z-10">
                <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-sm font-bold uppercase tracking-wider">Revenue Intelligence</h3>
                </div>
                <div className="flex flex-col items-end">
                    <span className={clsx("text-2xl font-black", getScoreColor())}>{score}%</span>
                    <span className="text-[8px] font-black uppercase tracking-[0.2em] text-white/30">Conv. Score</span>
                </div>
            </div>
