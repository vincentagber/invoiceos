...
exports.updateProfile = exports.deleteBusiness = exports.sendTestEmail = exports.updateEmail = exports.updateNotifications = exports.updateWorkflow = exports.updateInvoiceDefaults = exports.updateBranding = exports.updateBusiness = exports.getAll = void 0;
    ...
    try {
        ...
        if (logo) {
            if (logo.startsWith('http'))
                ...
                data.logo = logo; // Keep as base64 in text/bytea column
        }
        if (favicon) {
...
const updateInvoiceDefaults = async (req, res, next) => {
    try {
...
exports.updateInvoiceDefaults = updateInvoiceDefaults;
...
const sendTestEmail = async (req, res, next) => {
    try {
        ...
        logger_1.logger.error('SMTP Test Failure:', error);
